...
namespace Netdaemon.Generated.Reactive
{
    ...
    public partial class ScriptEntity : RxEntity
    {
        ...
        public void KodiSetSurroundMode(dynamic? data = null)
        {
            var serviceData = new FluentExpandoObject();
            if (data is ExpandoObject)
            {
            ...
            DaemonRxApp.CallService("script", "kodi_set_surround_mode", serviceData);
        }
        ...
        public void TvGamingConsoleDisableSurroundProcess(dynamic? data = null)
        {
            var serviceData = new FluentExpandoObject();
            if (data is ExpandoObject)
            {
            ...
            DaemonRxApp.CallService("script", "tv_gaming_console_disable_surround_process", serviceData);
        }
        ...
        public void TvPcEnableSurroundProcess(dynamic? data = null)
        {
            var serviceData = new FluentExpandoObject();
            if (data is ExpandoObject)
            {
            ...
            DaemonRxApp.CallService("script", "tv_pc_enable_surround_process", serviceData);
        }
    ...
    public partial class ScriptEntities
    {
        ...
        public ScriptEntity KodiSetSurroundMode => new ScriptEntity(_app, new string[]{"script.kodi_set_surround_mode"});
        ...
        public ScriptEntity TvGamingConsoleDisableSurroundProcess => new ScriptEntity(_app, new string[]{"script.tv_gaming_console_disable_surround_process"});
        ...
        public ScriptEntity TvPcEnableSurroundProcess => new ScriptEntity(_app, new string[]{"script.tv_pc_enable_surround_process"});
    ...
    public partial class CameraEntities
    {
        ...
        public CameraEntity BedRoomCamera => new CameraEntity(_app, new string[]{"camera.bed_room_camera"});
        ...
        public CameraEntity LivingRoomCamera => new CameraEntity(_app, new string[]{"camera.living_room_camera"});
    }
